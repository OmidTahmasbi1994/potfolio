    ...
    <Element name={"skills"}>
      <section className="mx-60 flex flex-col justify-baseline items-center gap-10 py-30 px-10 max-xl:mx-0 max-xl:py-20 max-sm:py-20 max-sm:mx-0 max-sm:gap-6">
        ...
        <motion.div
          ...
          className="border-solid border-1 border-gray-200 rounded-2xl shadow-lg shadow-gray-300 md:flex md:flex-row md:justify-around md:flex-wrap min-md:gap-5 min-md:p-7 max-md:grid max-md:grid-cols-4 max-md:gap-2 max-md:p-7"
        >
          <div className="md:w-[15%] bg-gray-50 border-solid border-1 border-gray-300 rounded-2xl shadow-lg shadow-gray-300 flex flex-col justify-start md:justify-center align-center gap-2">
          ...
          <div className="md:w-[15%] bg-gray-50 border-solid border-1 border-gray-300 rounded-2xl shadow-lg shadow-gray-300 flex flex-col justify-start md:justify-center align-center">
            <div className="max-md:h-[55%] px-5 py-2">
